...
typedef enum
{
    ...
    CLIENT_EVENT_FIND       = 0x0001,
    CLIENT_EVENT_MSG_READY  = 0x0002,
    CLIENT_EVENT_SETTINGS   = 0x0004,
    CLIENT_EVENT_UPDATE     = 0x0008,
    CLIENT_EVENT_REBOOT     = 0x0010,
    CLIENT_EVENT_DEFAULT    = 0x0020,
    CLIENT_EVENT_SYS_RELOAD = 0x0040,
    CLIENT_EVENT_MAX        = 0x0080,
}CLIENT_EVENT_e;
...
typedef void (*event_FillMsg_Callback_t)(search_out_msg_t *outMsg);
