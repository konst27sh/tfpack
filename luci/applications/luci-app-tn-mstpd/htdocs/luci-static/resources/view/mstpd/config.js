...
return L.view.extend({
	...
	populateBridgeParameters: function(m, s, br) {
		...
		// Global Enable
		o = s.option(form.ListValue, 'enabled',	_('Enable'),"Global enable of STP/RSTP");
		o.value('1', 'Enable');
		o.value('0', 'Disable');
		o.rmempty = true;
		o.write = function(section_id, value) {
			uci.set('network', 'switch', 'stp', value);
			uci.set('mstpd', 'global', 'enabled', value);
		};
		o.load = function(section_id) {
			return uci.get('mstpd', 'global', 'enabled');
		};
	...
	populateBridgePorts: function(m, s, br) {
		...
		o.width = '100px';
		o.renderWidget = function(section_id, option_id, cfgvalue) {
			return E('strong', {}, getPortName(section_id));
		};
	...
	render: function(data) {
		...
		*/
		...
		for (var i = 0; i < bridges.length; i++) {
			...
			s = m.section(form.NamedSection, br['name-cfg'], 'bridge_' + br['name-cfg'], _('STP/RSTP Settings'),
