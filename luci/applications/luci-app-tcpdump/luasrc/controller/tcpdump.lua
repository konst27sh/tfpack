...
function index()
	...
	entry({"admin", "diagnostics", "tcpdump"}, template("tcpdump"), _ "Tcpdump", 70).dependent =
		false

	page = entry({"admin", "diagnostics", "tcpdump", "capture_start"},
				 call("capture_start"), nil)
	page.leaf = true

	page = entry({"admin", "diagnostics", "tcpdump", "capture_stop"},
				 call("capture_stop"), nil)
	page.leaf = true

	page = entry({"admin", "diagnostics", "tcpdump", "update"}, call("update"), nil)
	page.leaf = true

	page = entry({"admin", "diagnostics", "tcpdump", "capture_get"},
				 call("capture_get"), nil)
	page.leaf = true

	page = entry({"admin", "diagnostics", "tcpdump", "capture_remove"},
